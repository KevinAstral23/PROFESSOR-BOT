...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('🐧 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 🐧', url=f'https://t.me/{SUPPORT_CHAT}')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("➕️ 𝖴𝗌𝖾 𝖬𝗒 𝖲𝖾𝗋𝗏𝗂𝖼𝖾 ➕️", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
        ...
        m=await message.reply_sticker("CAACAgQAAxkBAAEJTfJkiJ11AeXc4TngEz385sBcEG5GNQACUw4AArvn-FPCZ6FyjF3O5y8E")
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("🕯️️ 𝖨𝗇 𝗅𝗂𝗇𝖾 𝖰𝗎𝖾𝗋𝗒 🕯", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("🐧 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 🐧", url="https://t.me/Pixel_Penguin_SUPPORT")
            ],[      
